...
async def generate_portfolio(request: AuthRequest):
    ...
    """
    json_response = gemini_client.models.generate_content(model='gemini-1.5-pro', contents=json_prompt)
    ...
    """
    token_response = gemini_client.models.generate_content(model='gemini-1.5-flash', contents=token_prompt)
